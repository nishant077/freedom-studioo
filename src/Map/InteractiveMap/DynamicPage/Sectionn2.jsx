  ...
  return (
    <>
      <div className='flex-wrap overflow-x-hidden'>
        ...
        <div>
          <h2 className='text-[#36454F] text-center flex-wrap text-xl md:text-3xl font-bold mt-10'>
            {location.AboutTitle}
          </h2>
        </div>
            ...
            >
              <div className='container flex justify-stretch flex-wrap md:gap-2'>
                ...
                <img 
                  ...
                  className="md:h-60 md:w-60 w-36 h-36 object-cover mt-20 border-4 border-white shadow-lg rounded-lg p-2"
                  alt="Protest Scene" 
                />
              </div>
            </motion.div>
              ...
              <div className="mt-6 mr-10 text-justify">
                {words.map((word, index) => (
                  <motion.span
                    ...
                    className="font-normal md:text-xl flex-wrap text-[#343434] tracking-tight inline-block"
                  >
                    {word === " " ? "\u00A0" : word}{" "}
                  </motion.span>
                ))}
