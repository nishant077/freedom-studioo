     ...
     <div className='text-white mt-20 px-5 md:px-10 lg:px-20'>
      ...
      {/* Impact Box */}
       <div className='px-5 md:px-20 py-5 mt-5 rounded-lg'>
         <div className='grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 text-center relative'>
          ...
          >
            <img src={clientlogo} className='w-36 h-32 object-cover' alt='Clients' />
            <span className='text-xl md:text-2xl font-semibold mt-2'>
              {isInView && <CountUp start={0} end={20} duration={5} />}
          ...
          <motion.div
            ...
            className='flex flex-col items-center pb-4 md:pb-0'
          >
            <img src={projectlogo} className='w-36 h-32 object-cover' alt='Projects' />
            <span className='text-xl md:text-2xl font-semibold mt-2'>
              {isInView && <CountUp start={0} end={25} duration={5} />}
          ...
          >
            <img src={capture} className='w-36 h-32 object-cover' alt='Content Produced' />
            <span className='text-xl md:text-2xl font-semibold mt-2'> 
              {isInView && <CountUp start={0} end={250} duration={5} />}
              <span className="text-white">+</span> Content Produced
            </span>
          </motion.div>
           ...
           <motion.div
            ...
            className='flex flex-col items-center pt-4 md:pt-0'
          >
            <img src={countryReached} className='w-36 h-32 object-cover' alt='Countries Reached' />
            <span className='text-xl md:text-2xl font-semibold mt-2'>
              {isInView && <CountUp start={0} end={35} duration={5} />}
              <span className="text-white">+</span> Countries Reached
            </span>
          </motion.div>
        </div>
       </div>
